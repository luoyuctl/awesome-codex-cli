...
- [luoyuctl/agenttrace](https://github.com/luoyuctl/agenttrace) - Local-first TUI for auditing Codex, Claude Code, Gemini CLI, and OpenCode session logs: cost, tokens, tool failures, latency, diffs, health reports, and CI gates. ![GitHub stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=flat-square)
